...
`../mine-verify-cover/references/mine-family-core.md` §The mine family for the full 7-row family
table and the shared invariant (bounded unit -> clean-room miners -> consolidate -> skeptic verify
-> graded registry) all seven members follow, and §Routing boundary for the line that decides an

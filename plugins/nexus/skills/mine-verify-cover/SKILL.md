...
mine family points to. See that file's §The mine family for the full 8-row family table (including
`mine-verify-repo`, `mine-reference-model`, `mine-algorithm`, `mine-design`, and `mine-verify-flows`).

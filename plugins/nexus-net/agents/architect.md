...
model: opus
skills: create-implementation-plan, create-architecture-doc, system-design
---
# Architect Agent
...
Plan within this stack's structure and standards. Use the `system-design` skill for axis/tier decisions; detailed code patterns live in the stack skills. If the project ships its own `docs/conventions/` or `docs/architecture/`, treat those as overrides.

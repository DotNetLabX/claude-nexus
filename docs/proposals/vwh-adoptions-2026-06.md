...
**Delivered:** A1 (allocation / "cheapest correct locus" principle in `docs/architecture/README.md`) + A3 (`scripts/selfcheck.mjs`, adhoc-VwhSelfcheckAndPrinciple) + A6 provenance-tag half (adhoc-LessonsProvenance, nexus 1.18.2; first-person-voice half dropped by design) + A5 decision-log pilot (adhoc-DecisionLog, nexus 1.28.0; pipeline closed 2026-07-11).
**Remainder (backlog):** A2 declutter skill, A4 advisory nudges.

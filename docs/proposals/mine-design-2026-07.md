...
**Status:** Ratified — 2026-07-12 by Laurentiu, **scope: pilot authorization** (Confidence Medium at authorization; full adopt-ratification after the calibration-pair pilot re-derives confidence). Drafted 2026-07-11; research closed (taxonomy ratified in owner discussion, census-at-scale via P1, judge design via R4).

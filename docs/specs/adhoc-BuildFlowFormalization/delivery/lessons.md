...
- **[ROUTED-TO-PLUGIN → N4, learner 2026-06-14]** **In the plugin *dev* repo, `improve-skills`'s "route shipped-skill fixes to the feedback file" channel
...
- **[TRACKED → N5, learner 2026-06-14]** **A "convention" expressed across a skill + an ADR + a doc must reconcile in ONE canonical home, with
